...
>(function MultilineInput(
  ...
  // Always-true mounted guard: safeRenderableCall sites only fire from live
  // event handlers; there is no unmount race to guard without useEffect.
  const mountedRef = useRef(true)
  // Changes whenever the input changes — re-keys the cursor so its blink
  // phase restarts on activity. Derived, not state.
