...
export interface XCliApiError {
  readonly error: {
    readonly message: string
    readonly type: XCliErrorType
    readonly code: XCliErrorCode
    readonly param: string | null
    readonly details?: XCliErrorDetails
  }
}

export type XCliErrorType =
...
export type XCliErrorDetails = SubscriptionRequiredDetails | UsageLimitDetails
